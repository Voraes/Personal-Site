...
2. Add it to your shell config (e.g., `~/.zshrc`):
   ...
   ```
3. Customize it: The `~/.config/starship.toml` file is where you can tweak the look and feel. Here’s an example snipet(more in [Presets](https://starship.rs/presets/)):
   ```toml
   [prompt]
   add_newline = false
   [rust]
